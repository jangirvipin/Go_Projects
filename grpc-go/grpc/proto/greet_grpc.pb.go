...
const (
	...
	GreetService_GreetManyTime_FullMethodName = "/greet.GreetService/GreetManyTime"
...
type GreetServiceClient interface {
	...
	GreetManyTime(ctx context.Context, in *MessageList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GreetResponse], error)
	LongGreet(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[GreetRequest, NameList], error)
...
func (c *greetServiceClient) GreetManyTime(ctx context.Context, in *MessageList, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GreetResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], GreetService_GreetManyTime_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[MessageList, GreetResponse]{ClientStream: stream}
...
type GreetService_GreetManyTimeClient = grpc.ServerStreamingClient[GreetResponse]

func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[GreetRequest, NameList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], GreetService_LongGreet_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GreetRequest, NameList]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_LongGreetClient = grpc.ClientStreamingClient[GreetRequest, NameList]
...
type GreetServiceServer interface {
	...
	GreetManyTime(*MessageList, grpc.ServerStreamingServer[GreetResponse]) error
	LongGreet(grpc.ClientStreamingServer[GreetRequest, NameList]) error
...
func (UnimplementedGreetServiceServer) GreetManyTime(*MessageList, grpc.ServerStreamingServer[GreetResponse]) error {
	return status.Errorf(codes.Unimplemented, "method GreetManyTime not implemented")
}
func (UnimplementedGreetServiceServer) LongGreet(grpc.ClientStreamingServer[GreetRequest, NameList]) error {
...
func _GreetService_GreetManyTime_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).GreetManyTime(m, &grpc.GenericServerStream[MessageList, GreetResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_GreetManyTimeServer = grpc.ServerStreamingServer[GreetResponse]

func _GreetService_LongGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).LongGreet(&grpc.GenericServerStream[GreetRequest, NameList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_LongGreetServer = grpc.ClientStreamingServer[GreetRequest, NameList]
